...
1. [Pros and Contras of the different proposals](#summary-of-pros-and-contras-of-the-different-proposals)
2. [Storing data on-chain](#an-onchain-data-registry)
3. [Storing data off-chain, using a commitment scheme](#using-a-commitment-scheme)
5. [Storing data off-chain, using a signature scheme](#using-a-signature-scheme)
6. [Open questions](#open-questions)
7. [Other relevant ideas](#other-relevant-ideas)
8. [Resources](#resources)
</details>
   
## Summary of pros and contras of the different proposals

1. *Storing data on-chain*: imposes higher cost for the oracle maintainer, will probably be 
...
2. *Storing data off-chain, using a commitment scheme*: this will be really cheap for the 
...
3. *Storing data off-chain, using a signature scheme*: this will be even cheaper reducing  
